...
OVERLAY_DIR="$HOME/.local/share/emacs-sandbox"
...
ARGS=(
    ...
    # config/cache/local. Per-subdir binds further down (fontconfig,
    # dconf, gtk-*, .local/bin, .local/share/pnpm, pip, go-build) layer
    # on top of these as separate mounts.
